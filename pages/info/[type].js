...
export default function InfoPage() {
  ...
  if (data.error || data.success === false) return <p style={{ padding: "2rem", color: "red" }}>تعذر تحميل البيانات.</p>;

  return (
    <div style={{ padding: "2rem", color: "#fff", background: "#000" }}>
      <h1>{data.title || data.name}</h1>
      <img src={data.poster_path ? `https://image.tmdb.org/t/p/w500${data.poster_path}` : 'https://via.placeholder.com/300x450?text=No+Image'} alt="Poster" style={{ maxWidth: "300px", borderRadius: "10px" }} />
